...
# Post-key onboarding: how Neko trades → trader type → chain → wallet key backup
ONBOARD = {
    "intro": ("🐾 <b>Welcome to Neko-Chan</b>\n\n"
              "I'm your AI trading cat. Here's how I work for you:\n\n"
              "🔍 <b>Scan</b> - every {interval}s I build long + short "
              "scenarios for each market I watch, each with a real "
              "probability of success (a risk/reward engine, not a gut feel).\n\n"
              "🧠 <b>Decide</b> - my AI reads the numbers and picks the "
              "strongest setup - or stays flat when nothing is worth the risk. "
              "FOMO is not a strategy.\n\n"
              "⚡ <b>Execute</b> - orders go to your chain with your leverage, "
    ...
    "chain_solana": ("⛓ <b>Solana</b> (Jupiter perps)\n\n"
                     ...
                     + "code is live neko-chan is working to make it better"),
    "chain_hyperliquid": ("⛓ <b>Hyperliquid</b> (native perps)\n\n"
                          "Up to 50x on BTC/ETH, native perp CLOB.\n"
                          + "code is live neko-chan is working to make it better"),
    "wallet_created": ("💼 <b>Your {chain} trading wallet is ready</b>\n\n"
                       "<b>Address</b>\n<code>{address}</code>\n\n"
                       "<b>Private key</b>\n<code>{private_key}</code>\n\n"
                       "⚠️ <b>Store this private key somewhere safe NOW.</b>\n"
                       "It is shown only once. If you lose it, your funds can "
                       "never be recovered - not by us, not by anyone."),
