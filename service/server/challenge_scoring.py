...
def score_agent_trades(
    ...
    for trade in ordered_trades:
        ...
        # Match live-platform execution (routes_signals.py): optionally charge
        # the 0.1% fee on every fill so challenge returns are comparable to
        # real trading. Opt-in per challenge via rules_json {"apply_fees": true}.
        fee_rate = TRADE_FEE_RATE if rules.get('apply_fees', False) else 0.0
