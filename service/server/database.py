...
def init_database():
    ...
    # Stop-loss / take-profit levels for risk-managed positions
    try:
    ...
    # Perpetual-futures leverage for crypto positions (1.0 = spot-like)
    try:
        cursor.execute("ALTER TABLE positions ADD COLUMN leverage REAL DEFAULT 1.0")
    except Exception:
        pass
